 ...
 */
public class S3SyncFileIO extends S3FileIOBase {
  private static final Logger LOG = LoggerFactory.getLogger(S3SyncFileIO.class);
   ...
   *
   * <p>All fields are initialized by calling {@link S3SyncFileIO#initialize(Map)} later.
   */
  public S3SyncFileIO() {}
   ...
   */
  public S3SyncFileIO(SerializableSupplier<S3Client> s3) {
   ...
   */
  public S3SyncFileIO(SerializableSupplier<S3Client> s3, S3FileIOProperties s3FileIOProperties) {
    this.s3 = s3;
  ...
  private ExecutorService executorService() {
    if (executorService == null) {
      synchronized (S3SyncFileIO.class) {
        if (executorService == null) {
          executorService =
    ...
    try {
      DynConstructors.Ctor<MetricsContext> ctor =
          DynConstructors.builder(MetricsContext.class)
              .loader(S3SyncFileIO.class.getClassLoader())
