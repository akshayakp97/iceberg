...
public class TestS3AsyncInputStream {
    public static final S3MockApplication s3MockApplication = S3MockApplication.start("https://localhost:9192");
    private final S3AsyncClient s3 = S3AsyncClient.builder().endpointOverride(URI.create("https://localhost:9192")).build();
    private final Random random = new Random(1);

//    @Before
//    public void before() {
//        try {
//            s3.createBucket(CreateBucketRequest.builder().bucket("test_apatta_bucket").build());
